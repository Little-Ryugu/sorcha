...
class simulationConfigs:
    ...
    """flag deciding whether to download pointing information after first compute. If True will create a hdf5 file and fingerprint file on first run and on subsequent runs will load pointing information from this file. If False will precompute as normal for every run"""
